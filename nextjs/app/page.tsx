    ...
    <main className="page-shell">
      ...
      <section className="card full">
        <div className="section-heading">
          ...
          <span className="status">{environment?.runtime || "Loading…"}</span>
        </div>
        <dl className="info-grid">
          <Field label="Runtime" value={environment?.runtime || "Loading…"} />
          <Field label="Secure context" value={environment ? (environment.isSecureContext ? "Yes" : "No — Wisp Telegram requires HTTPS") : "Checking…"} />
          <Field label="Wisp Native" value={environment ? (environment.hasInjectedNative ? "Available" : "Not detected") : "Checking…"} />
          <Field label="Wisp EVM" value={environment ? (environment.hasInjectedEvm ? "Available" : "Not detected") : "Checking…"} />
      ...
      <div className="columns">
        ...
        <section className="card">
          ...
          {!isWalletConnectConfigured() && <p className="hint">WalletConnect requires <code>NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID</code>.</p>}
          <dl className="compact-info">
